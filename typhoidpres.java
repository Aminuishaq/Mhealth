...
public class typhoidpres extends AppCompatActivity {
    ImageButton imgbtnh, imgbtnrem;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_typhoidpres);
        ...
        imgbtnrem.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i = new Intent(typhoidpres.this, remainder.class);
                startActivity(i);
            }
        });
        ...
        imgbtnh.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(typhoidpres.this, typhoid_prev.class);
